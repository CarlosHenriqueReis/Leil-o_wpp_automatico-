"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.program = void 0;
 ...
 */const program = exports.program = new _commander.Command();program.version(packageJSON.version); //#region frontend
program.option('--frontend', 'Habilita o frontend');program.option('--frontend-path <path>', 'Caminho dos arquivos de frontend (pasta dist)'); //#endregion
//#region comum
program.option('-c, --config <path>', 'Arquivo JSON de configuração para inicialização'); // Host
program.option('-h, --host <host>', 'Host de execução');program.option('-p, --port <numero>', 'Porta de execução');program.option('-k, --secretKey <chave>', 'Chave secreta para validação de tokens');program.option('--startAllSession', 'Habilita a auto inicialização das sessões');program.option('--no-startAllSession', 'Desabilita a auto inicialização das sessões');
//#endregion
